---
name: decomd
description: Create and edit decomd Markdown that uses `<!-- decomd: ... -->` comment annotations to decorate preview HTML. Use when Codex needs to write decomd documents, choose between flex, column, grid, form, and hero annotations, or explain typical decomd usage patterns.
---
...
- Place `flex`, `column`, `grid(size_x)`, and `hero` directly under the heading they decorate.
